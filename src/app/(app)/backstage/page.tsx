...
interface BackstageRow {
  ...
  stress: number;
  owner: string;
  status: "In motion" | "New" | "Heavy";
}

const BACKSTAGE: BackstageRow[] = [
      ...
      <div className="mx-6 mt-4 flex items-center gap-3.5 rounded-2xl border border-glow bg-gradient-to-b from-glow-soft to-transparent p-4 lg:mx-8">
        ...
        <div className="flex-1">
          <div className="text-[14.5px] font-bold text-ink">
            Theo is holding 2 heavy items
          </div>
          <div className="text-xs text-ink-3">
            He procrastinates least, so work drifts to him. Consider
